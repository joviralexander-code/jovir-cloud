...
export default function Footer() {
  return (
    <footer style={{ background: "#0f172a", borderTop: "1px solid rgba(148,163,184,0.1)", padding: "32px 0" }}>
      <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 24px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
        ...
        <p style={{ fontFamily: "var(--font-open-sans)", fontSize: "0.75rem", color: "#475569" }} suppressHydrationWarning>
